...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-30" data-genuitec-path="/Ngers/WebRoot/per_course.jsp">
 <%  
   ...
   <%   
    ...
    %>  
<table width="100%" border="0" cellpadding="0" cellspacing="0" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-30" data-genuitec-path="/Ngers/WebRoot/per_course.jsp">
  <tr bgcolor="#333333">
    <td><table width="1300" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="110" height="20" align="center" bgcolor="#333333" class="baise"><a href="per_course.jsp"style="color:white">我的</a></td>
          ...
          <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr bgcolor="#E2E2E2">
              <td><table width="1300" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="100" rowspan="3"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/未标题-2.png',1)"><a href="per_ziliao.jsp"><img src="images/未标题-1.png" name="Image4" width="100" height="30" border="0" id="Image4" /></a></td>
                  <td rowspan="3">&nbsp;</td>
                </tr>
                <tr>
                  <td class="xiao">&nbsp;</td>
            ...
            <tr>
              <td><table width="1300" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="100" height="40" nowrap="nowrap" bgcolor="#E2E2E2" class="a1"><a href="per_page.jsp">我的首页</a></td>
                  <td width="100" nowrap="nowrap" bgcolor="#333333" class="a1"><span class="a2"><a href="per_course.jsp"style="color:white">学习的课程</a></span></td>
                ...
                <tr>
                 ...
                 <% 
                   ...
                   %>
                   <td>&nbsp;</td>
                  <td colspan="2"><a href="<%=url1 %>"><img src="<%=img %>" width="190" /></a>
                   <td> <h4><%=lesson %></h4>
                    <p class="xiao1">跟着名师学基础，让你轻松学习不费力。</p>
                     <a href="delete1.jsp?lesson=<%=lesson %>" onclick="link" ><input type="submit" name="delete" id="delete" value="删除" />
                   </td>
