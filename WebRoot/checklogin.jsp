...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-3" data-genuitec-path="/Ngersfirst/WebRoot/checklogin.jsp">

<div style=text-align:center data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-3" data-genuitec-path="/Ngersfirst/WebRoot/checklogin.jsp">
...

    {
        ...
        response.setHeader("refresh","1;url = MyJsp1.jsp");
