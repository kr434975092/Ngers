          ...
          <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="1300" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="100" height="40" nowrap="nowrap" bgcolor="#333333" class="a1"><span class="a2"><a href="per_page.html"style="color:white">我的首页</a></span></td>
                  <td width="100" nowrap="nowrap" bgcolor="#E2E2E2" class="a1"><a href="per_course.html">学习的课程</a></td>
